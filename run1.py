...
def AFG_CLONING():
    ...
    with ThreadPool(max_workers=70) as Aryan:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru+guru,'۱۲۳۴۵۶','Afghanistan','۱۲۳۴۵۶۷۸۹','kabul123','Afghan123','10002000','700800','Afghan12345','50006000','Afghanistan500600','Khan12@#','100200','first last']
